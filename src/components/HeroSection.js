export default function HeroSection() {
    return (
        <section className="relative flex justify-around items-center min-h-[50vh] w-[90vw] mt-4 mx-auto pr-4">
            ...
            <div className="w-[45vw] h-[60vh] bg-[rgba(23,23,23,1)] p-4 mr-4"></div>
        </section>
    );
}